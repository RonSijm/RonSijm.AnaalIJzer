...
$project = Join-Path $repositoryRoot "src\Tools\RonSijm.AnaalIJzer.Arse\RonSijm.AnaalIJzer.Arse.csproj"
$sourceOutput = Join-Path $repositoryRoot "src\Tools\RonSijm.AnaalIJzer.Arse\bin\$Configuration\net10.0"
$artifactOutput = Join-Path $repositoryRoot "build\Artifacts\Arse"
