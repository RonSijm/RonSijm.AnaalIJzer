...
This scenario demonstrates `ARCH_PROJ_001`: project-reference boundaries.
...
The analyzer still reports `ARCH_PROJ_001`, because the rule checks the MSBuild project graph itself.
...
- `Example.ProjectReferenceBoundaries.Domain`: `ARCH_PROJ_001 = 1`
