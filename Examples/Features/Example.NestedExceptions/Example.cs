...
// Presentation -> Persistence edge, so an endpoint depending on a Repository triggers ARCH_DEP_001.
//
...
//   InMemoryCachedOrderRepository      2  startsWith "InMemoryCached"        -> IS  Repository, ARCH_DEP_001
//   InMemoryCachedTestOrderRepository  3  exact type name                    -> NOT Repository
//   LegacyInMemoryCachedOrderRepository 4 exact type name                    -> IS  Repository, ARCH_DEP_001

using System.Reflection;
using Example.NestedExceptions;
...
namespace Example.NestedExceptions;
...
// ARCH_DEP_001: Depth 2 (even): the type is in Persistence.
...
// ARCH_DEP_001: Depth 4 (even): the exact type is included in Persistence again.
