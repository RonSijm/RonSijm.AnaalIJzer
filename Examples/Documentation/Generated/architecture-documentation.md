...
**Generated**: 2026-07-02T13:13:33Z
...
- **Layer** `Persistence`
  ...
  `name="Persistence"`
  - **Class** `Class endsWith="Repository"`
    Repository suffixes identify persistence access.
    `endsWith="Repository"`
