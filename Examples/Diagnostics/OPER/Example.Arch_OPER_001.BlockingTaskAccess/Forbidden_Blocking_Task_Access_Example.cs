...
namespace Example.Arch_OPER_001.BlockingTaskAccess;
...
public sealed class PizzaKitchen
{
	...
	// ARCH_OPER_001: the kitchen counter should not stop for a task.
	public void PrepareByWaiting(Task preparation)
	{
		preparation.Wait();
	}

	// ARCH_OPER_001: putting Result in a local still blocks for the pizza.
