...
namespace Example.Arch_OPER_001.ClockAccess;
...
public sealed class PizzaKitchen(PizzaClock clock)
{
	...
	// ARCH_OPER_001: checking the wall clock directly hides the kitchen's time dependency.
	public DateTime PrepareAtUtcNow()
	{
		return DateTime.UtcNow;
	}

	// ARCH_OPER_001: the local restaurant clock has the same architectural problem.
	public DateTime PrepareAtLocalNow()
	{
		return DateTime.Now;
	}

	// ARCH_OPER_001: today's date is still a direct system-clock read.
