...
namespace Example.Arch_RET_001.ConfiguredLiteralReturns;
...
{
	// ARCH_RET_001: an empty name is a missing menu decision.
	public string GetFeaturedPizzaName()
	{
		return "";
	}

	// ARCH_RET_001: 42 is configured as a forbidden slice-count sentinel.
	public int GetFeaturedSliceCount()
	{
		return 42;
	}

	// ARCH_RET_001: enum zero is still a literal return after the enum cast is unwrapped.
