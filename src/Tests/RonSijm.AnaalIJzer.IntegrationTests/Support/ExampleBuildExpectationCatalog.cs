...
internal static class ExampleBuildExpectationCatalog
{
	...
	[
		...
		Expect("Diagnostics/Example.Arch021.BlockingTaskAccess", (ArchitecturalDiagnosticIds.ForbiddenOperationPolicyViolation, 2)),
		Expect("Diagnostics/Example.Arch021.ClockAccess", (ArchitecturalDiagnosticIds.ForbiddenOperationPolicyViolation, 3)),
		Expect("Diagnostics/Example.Arch021.SelectedEnvironmentMember", (ArchitecturalDiagnosticIds.ForbiddenOperationPolicyViolation, 1)),
		Expect("Diagnostics/Example.Arch021.ServiceLocation", (ArchitecturalDiagnosticIds.ForbiddenOperationPolicyViolation, 1)),
		Expect("Diagnostics/Example.Arch022.RequiredOperation", (ArchitecturalDiagnosticIds.BehavioralOperationPolicyViolation, 1)),
		Expect("Diagnostics/Example.Arch022.RequiredOperationBefore", (ArchitecturalDiagnosticIds.BehavioralOperationPolicyViolation, 1)),
		...
		ExpectFile("Features/Example.GeneratedCode", (ArchitecturalDiagnosticIds.ForbiddenOperationPolicyViolation, 1)),
		...
		Expect("Features/Example.NameRuleIntraProceduralTracking", (ArchitecturalDiagnosticIds.NameRuleViolation, 3)),
		Expect("Features/Example.NameRuleLanguageForms", (ArchitecturalDiagnosticIds.NameRuleViolation, 8)),
		...
		ExpectFile("Scenarios/Example.AspNetCore/Example.AspNetCore.ApiSurface", (ArchitecturalDiagnosticIds.ApiSurfaceLeakage, 1)),
		ExpectFile("Scenarios/Example.AspNetCore/Example.AspNetCore.LayerBoundaries", (ArchitecturalDiagnosticIds.IllegalLevelDependency, 1)),
		ExpectFile("Scenarios/Example.AspNetCore/Example.AspNetCore.ModelBindingNames", (ArchitecturalDiagnosticIds.NameRuleViolation, 2)),
		ExpectFile("Scenarios/Example.AspNetCore/Example.AspNetCore.OperationContracts", (ArchitecturalDiagnosticIds.OperationContractViolation, 1)),
		ExpectFile("Scenarios/Example.EntityFrameworkCore/Example.EntityFrameworkCore.ContextBoundary", (ArchitecturalDiagnosticIds.IllegalLevelDependency, 1)),
		ExpectFile("Scenarios/Example.EntityFrameworkCore/Example.EntityFrameworkCore.ContextCreation", (ArchitecturalDiagnosticIds.IllegalLevelDependency, 1)),
		ExpectFile("Scenarios/Example.EntityFrameworkCore/Example.EntityFrameworkCore.DomainPurity", (ArchitecturalDiagnosticIds.IllegalLevelDependency, 1)),
		ExpectFile("Scenarios/Example.EntityFrameworkCore/Example.EntityFrameworkCore.MigrationPlacement", (ArchitecturalDiagnosticIds.SourceLocationViolation, 1)),
		ExpectFile("Scenarios/Example.EntityFrameworkCore/Example.EntityFrameworkCore.ModelConfigurationPlacement", (ArchitecturalDiagnosticIds.SourceLocationViolation, 1)),
		ExpectFile("Scenarios/Example.EntityFrameworkCore/Example.EntityFrameworkCore.QuerySurface", (ArchitecturalDiagnosticIds.IllegalLevelDependency, 1)),
		...
		ExpectFile("Scenarios/Example.ProjectReferenceRuleSelectors/Example.ProjectReferenceRuleSelectors.Orders.Application", (ArchitecturalDiagnosticIds.ProjectReferenceViolation, 1)),
