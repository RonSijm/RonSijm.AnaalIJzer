...
{
	private static void AnalyzeInvocationNameRules(SyntaxNodeAnalysisContext context, AnalyzerConfig config, ConcurrentBag<ViolationRecord> violations, InvocationExpressionSyntax invocation)
	{
	...
	private static void AnalyzeObjectCreationNameRules(SyntaxNodeAnalysisContext context, AnalyzerConfig config, ConcurrentBag<ViolationRecord> violations, ExpressionSyntax objectCreation)
	{
	...
	private static void AnalyzeLocalInitializerNameRules(SyntaxNodeAnalysisContext context, AnalyzerConfig config, ConcurrentBag<ViolationRecord> violations, LocalDeclarationStatementSyntax localDecl)
	{
	...
	private static void AnalyzeFieldInitializerNameRules(SyntaxNodeAnalysisContext context, AnalyzerConfig config, ConcurrentBag<ViolationRecord> violations, FieldDeclarationSyntax fieldDecl)
	{
	...
	private static void AnalyzePropertyInitializerNameRules(SyntaxNodeAnalysisContext context, AnalyzerConfig config, ConcurrentBag<ViolationRecord> violations, PropertyDeclarationSyntax propertyDecl)
	{
